...
var pois = [
  PointOfInterestModel(
      13, 7, 'Castelo de São Jorge', 20, 10, 3, LatLng(38.7139092, -9.1334762)),
  PointOfInterestModel(14, 2, 'Capela Nossa Senhora da Saúde', 20, 15, 5,
      LatLng(38.71586278, -9.13569194)),
  PointOfInterestModel(15, 5, 'Tasquinha A Vaidosa', 20, 7.5, 2,
      LatLng(38.71695138, -9.13441912)),
  PointOfInterestModel(
      16, 7, 'Palácio da Rosa', 20, 15, 1, LatLng(38.714776, -9.1346331)),
  PointOfInterestModel(
      17, 1, 'Pérola do Rossio', 20, 15, 1, LatLng(38.71356062, -9.13862817)),
  PointOfInterestModel(18, 6, 'Casa dos Bicos - Fundação José Saramago', 20, 3,
      2, LatLng(38.709058, -9.1326586)),
  PointOfInterestModel(19, 3, 'Miradouro do Recolhimento', 20, 25, 5,
      LatLng(38.71267494, -9.13171991)),
  PointOfInterestModel(20, 3, 'Miradouro de Santa Luzia', 20, 25, 1,
      LatLng(38.71159619, -9.13034395)),
  PointOfInterestModel(
      22, 7, 'Elevador da Bica', 20, 3.7, 5, LatLng(38.70858166, -9.14669643)),
  PointOfInterestModel(23, 7, 'Elevador de Santa Justa', 20, 5.15, 2,
      LatLng(38.71212908, -9.1394235)),
  PointOfInterestModel(24, 7, 'Elevador da Glória', 20, 3.7, 3,
      LatLng(38.71539594, -9.14335103)),
  PointOfInterestModel(25, 2, 'Igreja de São Nicolau', 20, 25, 3,
      LatLng(38.71093597, -9.13669238)),
  PointOfInterestModel(
      26, 1, 'Nicolau Café', 20, 0, 1, LatLng(38.7105554, -9.1364516)),
  PointOfInterestModel(
      27, 8, 'Praça do Comércio', 20, 20, 5, LatLng(38.707532, -9.1364489)),
  PointOfInterestModel(
      28, 3, 'Cais das Colunas', 20, 20, 2, LatLng(38.70661524, -9.1360868)),
  PointOfInterestModel(29, 6, 'Museu de Lisboa - Torreão Poente', 20, 20, 3,
      LatLng(38.7067785, -9.13726697)),
  PointOfInterestModel(30, 6, 'Museu do Design e da Moda', 20, 0, 5,
      LatLng(38.7090582, -9.1369361)),
  PointOfInterestModel(
      31, 3, 'Arco da Rua Augusta', 20, 0, 1, LatLng(38.70839262, -9.13682345)),
  PointOfInterestModel(32, 2, 'Igreja da Nossa Senhora da Conceição Velha', 20,
      0, 3, LatLng(38.70896476, -9.13423873)),
  PointOfInterestModel(
      33, 8, 'Praça do Rossio', 20, 10, 1, LatLng(38.7137188, -9.1396806)),
  PointOfInterestModel(34, 6, 'O Mundo Fantástico da Sardinha Portuguesa', 20,
      0, 4, LatLng(38.7144703, -9.1393499)),
  PointOfInterestModel(
      35, 1, 'Nicola Café', 20, 0, 3, LatLng(38.71321458, -9.13967177)),
  PointOfInterestModel(
      36, 8, 'Praça da Figueira', 20, 7.5, 4, LatLng(38.71372417, -9.13786591)),
  PointOfInterestModel(
      37, 2, 'Igreja da Madalena', 20, 7.5, 2, LatLng(38.7101015, -9.13476212)),
  PointOfInterestModel(38, 2, 'Igreja de Santo António de Lisboa', 20, 7.5, 2,
      LatLng(38.70999347, -9.13401066)),
  PointOfInterestModel(
      39, 7, 'Sé de Lisboa', 20, 0, 77, LatLng(38.70980306, -9.13340813)),
  PointOfInterestModel(40, 2, 'Igreja de São Domingos', 20, 0, 92,
      LatLng(38.71470839, -9.13875324)),
  PointOfInterestModel(41, 1, 'Hospital de Bonecas', 20, 5, 18,
      LatLng(38.71417458, -9.13776636)),
  PointOfInterestModel(
      42, 1, 'Manteigaria Silva', 20, 5, 32, LatLng(38.71406446, -9.13876112)),
  PointOfInterestModel(43, 6, 'Museu Arqueológico do Carmo', 20, 5, 50,
      LatLng(38.71190513, -9.14063627)),
  PointOfInterestModel(44, 6, 'Museu Nacional de Arte Contemporânea do Chiado',
      20, 25, 97, LatLng(38.70968009, -9.14102261)),
];
...
var pois2 = [
  PointOfInterestModel(32, 2, 'Igreja da Nossa Senhora da Conceição Velha', 20,
      0, 3, LatLng(38.70896476, -9.13423873)),
  PointOfInterestModel(
      33, 8, 'Praça do Rossio', 20, 0, 1, LatLng(38.7137188, -9.1396806)),
  PointOfInterestModel(34, 6, 'O Mundo Fantástico da Sardinha Portuguesa', 20,
      0, 4, LatLng(38.7144703, -9.1393499)),
  PointOfInterestModel(
      35, 1, 'Nicola Café', 20, 0, 3, LatLng(38.71321458, -9.13967177)),
  PointOfInterestModel(
      36, 8, 'Praça da Figueira', 20, 0, 4, LatLng(38.71372417, -9.13786591)),
  PointOfInterestModel(
      37, 2, 'Igreja da Madalena', 20, 0, 2, LatLng(38.7101015, -9.13476212)),
  PointOfInterestModel(38, 2, 'Igreja de Santo António de Lisboa', 20, 0, 2,
      LatLng(38.70999347, -9.13401066)),
  PointOfInterestModel(
      39, 7, 'Sé de Lisboa', 20, 0, 77, LatLng(38.70980306, -9.13340813)),
  PointOfInterestModel(40, 2, 'Igreja de São Domingos', 20, 0, 92,
      LatLng(38.71470839, -9.13875324)),
  PointOfInterestModel(41, 1, 'Hospital de Bonecas', 20, 0, 18,
      LatLng(38.71417458, -9.13776636)),
  PointOfInterestModel(
      42, 1, 'Manteigaria Silva', 20, 0, 32, LatLng(38.71406446, -9.13876112)),
  PointOfInterestModel(43, 6, 'Museu Arqueológico do Carmo', 20, 0, 50,
      LatLng(38.71190513, -9.14063627)),
  PointOfInterestModel(44, 6, 'Museu Nacional de Arte Contemporânea do Chiado',
      20, 0, 97, LatLng(38.70968009, -9.14102261)),
];
